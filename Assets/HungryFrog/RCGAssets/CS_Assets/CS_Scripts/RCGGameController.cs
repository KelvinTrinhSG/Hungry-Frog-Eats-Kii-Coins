...
namespace RoadCrossing
{
	...
	public class RCGGameController : MonoBehaviour
	{
		...
		void Start()
		{
			...
			if (BlockchainShopManager.Instance.gold == 50)
			{
				ChangeScore(50);
			}
			else {
			...
			if (BlockchainShopManager.Instance.hp == 1)
			{
			...
			if (BlockchainShopManager.Instance.goldx2 == 2)
			{
		...
		{
			BlockchainShopManager.Instance.gold = 0;
			BlockchainShopManager.Instance.hp = 0;
			BlockchainShopManager.Instance.goldx2 = 1;
